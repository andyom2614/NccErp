...
const menuItems = {
  admin: [
    ...
    { id: 'units', label: 'Manage Units', icon: Shield },
    { id: 'colleges', label: 'Manage Colleges', icon: Building },
    { id: 'ano-contacts', label: 'ANO Contacts', icon: Users },
    { id: 'test-api', label: 'Test API Connection', icon: Activity },
    { id: 'debug-emails', label: 'Debug College Matching', icon: Bug },
