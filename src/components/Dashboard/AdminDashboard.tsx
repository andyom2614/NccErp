...
const recentActivity = [
  ...
  { action: 'User permissions updated', user: 'admin@ncc.gov', time: '1 hour ago', type: 'info' },
        ...
        >
          ...
          <div className="space-y-3">
            {[
              ...
              { label: 'Manage Units', color: 'from-indigo-500 to-indigo-600' },
              { label: 'Manage Colleges', color: 'from-purple-500 to-purple-600' },
